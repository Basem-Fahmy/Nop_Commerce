...
public class TC_01_Search_With_Existing_Product extends Base_Class {
    ...
    public void TC_01
        ...
        driver.findElement(Search_Bar).sendKeys(Existing_Product);  // enter product name
        driver.findElement(Search_Submit).click();  // click search button
        String x = driver.findElement(Search_Result).getText();  // result of your search

        //Assertion
        //Expected & Actual Result : search result  = entered product name  "x"
        Assert.assertEquals(x,Existing_Product);
        //Assertion
    }
