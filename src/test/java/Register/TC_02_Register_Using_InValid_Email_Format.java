...
public class TC_02_Register_Using_InValid_Email_Format extends Base_Class {
    ...
    public void TC_02
        ...
        driver.findElement(Email_Input).sendKeys(Invalid_Email_Format);   //enter email
        ...
        //Assertion
        String message = driver.findElement(Register02_Assertion_Element).getText();
        //Expected & Actual Result : user see [message] "Wrong email"
