...
public class TC_04_Set_Quantity_For_Product_To_Zero extends Base_Class {
    ...
    public void TC_04
        ...
        driver.findElement(Qty_Value).sendKeys("0"); // set value to "0"
        driver.findElement(Update_Cart).click(); // click update cart btn

        //Assertion
        String message = driver.findElement(Shopping_Cart_04_Assertion_Element).getText();
        //Expected & Actual Result : user see [message] "Your Shopping Cart is empty!"
