...
public class TC_06_Edit_Existing_Address_With_No_Changes extends Base_Class {
    ...
    public void TC_06
        ...
        //Expected Result : user see [message] "You should enter new address before saving"
        //Actual Result  : not as expected
        Assert.assertEquals(message,"You should enter new address before saving");
        //Assertion
    }
    ...
    public void takescreenshoot() throws IOException {
        ...
        ImageIO.write(screenshot.getImage(), "jpg", new File(("./bug_images/TC06_My_Account_Img.jpg")));
