...
public class TC_05_Edit_Existing_Address extends Base_Class {
    ...
    public void TC_05
        ...
        driver.findElement(Edit_Address_Btn).click();  // click edit address  button

        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        driver.findElement(Add_Address1_Input).clear();
        driver.findElement(Add_Address1_Input).sendKeys("new_address_01");
        driver.findElement(Add_Address2_Input).clear();
        driver.findElement(Add_Address2_Input).sendKeys("new_address_02");
        driver.findElement(Save_New_Address).click(); // click save changes button

        //Assertion
        String message = driver.findElement(Store02_Assertion_Element).getText();
        //Expected & Actual Result : user see [message] "The address has been updated successfully."
