...
public class TC_03_Change_First_And_Last_Name_With_Empty_Input extends Base_Class {
    ...
    public void TC_03
        ...
        //Assertion
        String message = driver.findElement(My_Account_03_Assertion_Element).getText();
        //Expected & Actual Result : user see [message] "First name is required"
